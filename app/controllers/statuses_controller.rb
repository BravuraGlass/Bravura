class StatusesController < ApplicationController
  ...
  # GET /statuses.json
  def index
    @statuses = Status.order(:category).order(:order)
  end
  ...
  def update
    respond_to do |format|
      if @status.update(status_params)
        ...
        format.html { redirect_to statuses_path(params_redirect), notice: 'Status was successfully updated.' }
  ...
  private
    ...
    def status_params
      params.require(:status).permit(:name, :order, :category)
    end
