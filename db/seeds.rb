...
User.create(email: 'admin@admin.com',password: 'admin',first_name: 'Kevin', last_name: 'Admin',phonenumber: '555 555 5555',address: 'admin address',type_of_user: '0', always_access: true)
