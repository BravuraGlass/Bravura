...
class ProductTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_type" do
    assert_difference('ProductType.count') do
      post product_types_url, params: { product_type: { description: @product_type.description, name: @product_type.name } }
    end
  ...
  test "should update product_type" do
    patch product_type_url(@product_type), params: { product_type: { description: @product_type.description, name: @product_type.name } }
